        ...
        If (Membership.ValidateUser(LoginUser.UserName, LoginUser.Password)) Then
            ...
            If IsPostBack = True Then
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    obj.ExecuteQuery("insert into CF_logdet(LogId, LogName,LoginTime,Ipname) values('" + id + "','" + uname.Text + "','" & Format(System.DateTime.Now, "yyyy/MM/dd hh:mm:ss") & "','" + strIPAddress + "')")
