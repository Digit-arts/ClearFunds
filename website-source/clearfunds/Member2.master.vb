...
Partial Class Member
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        lblActiveAccounts.Text = obj.Returnsinglevalue("select COUNT (USER_ID) from CF_User a inner join CF_Deposit b on b.Deposit_UserId=a.User_UserId where Deposit_Status='true'")
        lblTotalDeposited.Text = obj.Returnsinglevalue("select SUM (Deposit_Amount) from CF_Deposit where Deposit_Status='true'")
        lblTotalWithdraw.Text = obj.Returnsinglevalue("select SUM(WithDrawl_Amount) from CF_WithDrawl where WithDrawl_Status='true'")
