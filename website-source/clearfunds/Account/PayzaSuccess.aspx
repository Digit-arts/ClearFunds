<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PayzaSuccess.aspx.vb"  MasterPageFile="~/AccountMaster.master"  Inherits="Success" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="MainContent">
    ...
    <asp:Label  ID="Label1" Font-Size="Large"  runat="server" Text=" Payment received successfully!!!"
        ...
        <asp:Label ID="lblDet" runat="server" Visible="false" Text="Label"></asp:Label>
    </div>
