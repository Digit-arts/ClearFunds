...
Partial Class Success
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        Dim tranref As String = "", transtat As String = "", tranamt As String = "", trandate As Date, tranuserid As String = "", output As String = ""
        If Not Page.IsPostBack Then
            Try
                'tranref = Request("ap_referencenumber").ToString()
                'transtat = Request("ap_status").ToString()
                'tranamt = Request("ap_totalamount").ToString()
                'trandate = Request("ap_transactiondate").ToString()
                ...
                'cmd.ExecuteNonQuery()
                'con.Close()
                query = "update CF_Deposit set Deposit_Status= 'True' where Deposit_Id='" + Session("Deposit_Id") + "'"
                con.Open()
                cmd = New SqlCommand(query, con)
                cmd.ExecuteNonQuery()
                con.Close()
