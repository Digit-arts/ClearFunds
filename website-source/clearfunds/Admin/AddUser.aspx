<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AddUser.aspx.vb" MasterPageFile ="~/Admin/Site.master"  Inherits="Admin_AddUser" %>
...
<tr>
 <td>
  <asp:Label ID="lblMobilno" Text="MobileNo" runat="server"  ></asp:Label>
 </td>
   <td>
