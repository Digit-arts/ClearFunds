...
Partial Class Admin_ManageUser
    ...
    Protected Sub Edit_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        Response.Redirect("AddUser.aspx?id=" + lbldeleteID.Text)
    End Sub
    ...
    Protected Sub Delete_Click(ByVal sender As Object, ByVal e As ImageClickEventArgs)
        ...
        con.Open()
        cmd = New SqlCommand("Delete from Admin_Users where AdminTickets_id='" + lbldeleteID.Text + "'", con)
        cmd.ExecuteNonQuery()
        cmd.ExecuteNonQuery()
        con.Close()
        bindgrid()
    ...
    Private Sub bindgrid()
        obj.returndatatable("select * from Admin_Users", dt)
