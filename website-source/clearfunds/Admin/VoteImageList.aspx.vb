...
Partial Class Admin_VoteImageList
    ...
    Public Sub bindgrid()
        ...
        dt = obj.returndatatable("select * from CF_VoteUs where   VoteUs_Isdeleted<>'1'", dt)
    ...
    Protected Sub Delete_Click(sender As Object, e As ImageClickEventArgs)
        ...
        con.Open()
        Dim cmd As New SqlCommand("update [CF_VoteUs] set [VoteUs_Isdeleted]='1' where [VoteUs_id]='" + lbldeleteID.Text + "'", con)
        cmd.ExecuteNonQuery()
        con.Close()
        bindgrid()
