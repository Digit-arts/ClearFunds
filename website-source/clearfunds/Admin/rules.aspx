<%@ Page Title="" Language="VB" MasterPageFile="~/Admin/Site.master" AutoEventWireup="false" CodeFile="rules.aspx.vb" Inherits="Admin_rules" %>
...
<asp:GridView ID="GVSupportList"  AutoGenerateColumns="false" runat="server" CssClass="pack_tab">
    ...
    <ItemTemplate>'<%# Eval("CMS_Rules_Id")%>'
    </ItemTemplate>
    </asp:TemplateField>
    <asp:TemplateField HeaderText="packagename">
    <ItemTemplate>
   <%# Eval("CMS_Rules_Subject")%>
    </ItemTemplate>
    ...
    <%--<asp:ImageButton ID="ImageButton1"   OnCommand="GVPackageList_Command"  AlternateText="Edit" CommandName="Edit" ImageUrl="Images/add.jpg" CommandArgument='<%#Eval("package_id") %>'  runat="server" />--%>
     <%--<asp:HyperLink ID="HyperLink1"  Text="Edit" runat="server" ></asp:HyperLink>--%>
        <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl='<%#"~/admin/AddEditRules.aspx?Pid="+Eval("CMS_Rules_Id")%>'>Edit</asp:LinkButton>
    </ItemTemplate>
    </asp:TemplateField> 
  ...
  <div class="add_button">
    <a href="AddEditRules.aspx" title="Add new Rule Content!">
