...
Public Class FileHandler : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        dt = obj.returndatatable("select * from CF_Extras_Advertisement where Extras_Advertisement_Id='" + str + "'", dt)
        context.Response.BinaryWrite(DirectCast(dt.Rows(0).Item("Extras_Advertisement_Image"), Byte()))
